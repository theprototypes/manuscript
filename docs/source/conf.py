...
Basic
'''
project = '&nbsp; <span style="vertical-align: super; padding-top: 0; padding-bottom: 0;">Manuscript</span>'
...
html_theme_options = {
    'canonical_url': 'https://theprototypes.github.io/manuscript/',
    ...
    'includehidden': True,
    'titles_only': False,
    'github_url': 'https://www.github.com/theprototypes/manuscript',
...
html_title = 'Strategic Aims & Roles'
...
html_context = {
    'landing_page': {
        'menu': [
            {'title': '<span style="font-variant: small-caps">The artificial intelligence unit</span>',
             'url': 'https://github.com/theartificialintelligenceunit'},
            {'title': '<span style="font-variant: small-caps; margin-left: 35px">Introduction</span>',
             'url': 'introduction.html'}
        ]
    },
    'display_github': True,
    'github_repo': 'theprototypes/manuscript',
